      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center px-4">
          <div className="text-center text-blue-800 max-w-2xl">
            ...
            <p className="text-lg md:text-xl mb-8 text-gray-800 font-semibold">
              Manage income, track spending, and grow your savings—all in one
              app.
            </p>
            ...
            <SPButton
              ...
              className={cn("!bg-blue-900 hover:!bg-blue-800 !text-white")}
            >
